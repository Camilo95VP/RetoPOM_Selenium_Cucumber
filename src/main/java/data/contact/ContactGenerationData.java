...
public class ContactGenerationData extends ContactModel {
    ...
    public static ContactModel contactData() {

        Faker fk= Faker.instance(new Locale("es-ES"));
        ContactModel contactModel=new ContactModel();
        contactModel.setName(fk.name().fullName());
        contactModel.setEmail(fk.internet().emailAddress());
        contactModel.setEnquiry(fk.lorem().characters(10));
